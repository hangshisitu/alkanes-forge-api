...
export async function getUtxoByAddress(address) {
...
export async function getAddressTxsChain(address, last_seen_txid) {
...
export async function getTxOutspend(txid, vout) {
    const start = new Date().getTime()
...
export async function getTxOutspends(txid) {
    const start = new Date().getTime()
...
export async function getTxStatusEx(txid) {
    const start = new Date().getTime()
...
export async function postTxEx(txHex) {
    const start = new Date().getTime()
...
export async function getMempoolRecent() {
...
export async function getBlocksTipHeight(txid){
